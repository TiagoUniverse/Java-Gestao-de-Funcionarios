...
public class Main {
    ...
    Cargo programador, Cargo administrador, int respostaCargo) {
        switch(escolha){
            case 1:
                ...
                if (escolha_opcao == 1){
                    escolherCargo(programador, administrador, respostaCargo);
    ...
    private  static int escolherCargo(Cargo programador, Cargo administrador, int respostaCargo){
        do {
            System.out.println("----------------");
